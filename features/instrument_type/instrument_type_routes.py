...
from features.instrument_type.instrument_type_schema import InstrumentTypeCreate, InstrumentTypeInDb, InstrumentTypeUpdate
...
async def list_instrument_types(
    ...
    instrument_types = await instrument_type_service.get_all_instrument_types(session=session)
